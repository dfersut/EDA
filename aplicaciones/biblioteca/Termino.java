...
public class Termino {
    ...
    public int hashCode() { 
        ...
        /* FIN COMPLETAR 
        for(int i=0; i<this.termino.length(); i++){
            this.valorHash = this.valorHash * this.baseHashCode + this.termino.charAt(i);
        }   
        */
    ...
    public boolean equals(Object otro) {
        /*
        if (otro instanceof Termino && (this.valorHash == ((Termino)otro).valorHash)) return ((Termino)otro).termino.equals(this.termino);
        else return false;
        */
        if(this.valorHash != ((Termino)otro).valorHash) return false;
        else return this.termino.equals(otro);
    }
